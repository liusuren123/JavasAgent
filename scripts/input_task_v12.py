...
# 5. 截图确认
img = ImageGrab.grab(bbox=(50, 1570, 900, 1605))
img.save("scripts/input_v12_check.png")
...
# 7. 最终截图
img2 = ImageGrab.grab(bbox=(0, 1300, 1000, 1600))
img2.save("scripts/agent_v12_final.png")
print("完成！")
