"""在 Zed Agent 输入框中粘贴并发送任务 - 不碰 Edits 面板。"""
import sys
import time
import subprocess
...
# 2. 点击输入框中心（坐标 76~296, 922~944 → 中心约 186, 933）
input_x, input_y = 186, 933
...
# 5. 截图确认
img = ImageGrab.grab(bbox=(50, 910, 950, 960))
img.save("scripts/input_v9_check.png")
...
img2.save("scripts/agent_v9_final.png")
print("完成！")
